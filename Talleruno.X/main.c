...
void conforP2(void) {
    ...
    /*
     Lo más viables es hacerlo por mascara de bits porque se ahorra mas línes de c+odigo que hacerlo manualmente
     */
}
...
void LedsP11(void) {
    ...
    OPTION_REGbits.nWPUEN = 0; //Habilitamos resistencias de pull up internas
